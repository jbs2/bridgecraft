...
//Math functions
	...
	inline
	Tuple3fT sub(const Tuple3fT& a, const Tuple3fT& b) {
		Tuple3fT r;
		r.s.X=a.s.X-b.s.X;
		r.s.Y=a.s.Y-b.s.Y;
		r.s.Z=a.s.Z-b.s.Z;
	...
	inline
	static GLfloat lengthSquared(const Tuple3fT& a) {
		return	(a.s.X * a.s.X)+
				(a.s.Y * a.s.Y)+
				(a.s.Z * a.s.Z);
	}
	...
	inline
	static GLfloat length(const Tuple3fT& a) {
		return FuncSqrt(lengthSquared(a));
	}
...
// 8<--Snip here if you have your own math types/funcs-->8 
    ...
    typedef class ArcBall_t
    {
        ...
        public:
			...
			void	clickL(const Point2fT* NewPt);
